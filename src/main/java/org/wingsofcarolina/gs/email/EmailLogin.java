...
public class EmailLogin {
	...
	static final String SERVER = "https://0bc5-2605-a601-a606-7500-00-58.ngrok-free.app";

	// The subject line for the email.
	static final String SUBJECT = "WCFC Groundschool Login";

	// The HTML body for the email.
	static final String HTMLBODY = "<div class=title>WCFC Groundschool Login</div>"
			+ "<p>This email contains a URL you can use to log into the WCFC groundschool server. "
			+ "This URL is good for roughly 24 hours after which you will need to request another login. Once "
	...
	static final String TEXTBODY = "WCFC Groundschool Login\n"
			...
			+ "This URL is good for roughly 24 hours after which you will need to request another login.\n"
	...
	public void emailTo(String email, String uuid) {
		...
		String htmlBody = HTMLBODY.replace("UUID", uuid).replace("EMAIL", email).replace("CODE", code.toString());
		String textBody = TEXTBODY.replace("UUID", uuid).replace("EMAIL", email).replace("CODE", code.toString());
